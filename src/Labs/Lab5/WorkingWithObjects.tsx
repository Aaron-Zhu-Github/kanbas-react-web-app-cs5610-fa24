...
export default function WorkingWithObjects() {
    ...
    return (
        ...
        {/* assignment */}
        <a id="wd-update-assignment-title" // update assignment title
        ...
        <hr />
        <a id="wd-update-assignment-score" // update assignment score
            className="btn btn-primary float-end"
        ...
        <hr />
        <a id="wd-update-assignment-completed" // update assignment completed
            className="btn btn-primary float-end"
